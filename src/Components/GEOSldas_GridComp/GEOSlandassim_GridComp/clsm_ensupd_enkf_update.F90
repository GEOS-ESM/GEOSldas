       ...
       if (root_proc) then
          ...
          do k=1,kmax
             ...
             if (use_real8) then
                ...
                call grid2tile( tile_grid_g, N_catf, tile_coord_f%hash_i_indg,tile_coord_f%hash_j_indg, data_h_9km_grid, &
                     data_h_9km_tile )

                call grid2tile( tile_grid_g, N_catf, tile_coord_f%hash_i_indg,tile_coord_f%hash_j_indg, data_v_9km_grid, &
                     data_v_9km_tile )
