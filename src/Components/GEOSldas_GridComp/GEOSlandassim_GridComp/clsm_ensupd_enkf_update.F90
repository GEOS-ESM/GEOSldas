       ...
       if (root_proc) then
          ...
          do k=1,kmax
             ...
             if (use_real8) then
                ...
                call grid2tile_simple( tile_grid_g, N_catf, tile_coord_f%i_indg, tile_coord_f%j_indg, data_h_9km_grid_8, &
                     data_h_9km_tile_8 )

                call grid2tile_simple( tile_grid_g, N_catf, tile_coord_f%i_indg, tile_coord_f%j_indg, data_v_9km_grid_8, &
                     data_v_9km_tile_8 )
                ...
                call grid2tile_simple( tile_grid_g, N_catf, tile_coord_f%i_indg,tile_coord_f%j_indg, data_h_9km_grid, &
                     data_h_9km_tile )

                call grid2tile_simple( tile_grid_g, N_catf, tile_coord_f%i_indg,tile_coord_f%j_indg, data_v_9km_grid, &
                     data_v_9km_tile )
